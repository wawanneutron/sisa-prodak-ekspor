                ...
                <div class=" float-right" style="margin-top: -30px;">
                    <a href="
                        @switch(auth()->user()->role)                                                                                                                                             
                            ...
                            @break
                            @case('SPV')
                                {{ route('spv-laporan-pengajuan') }}
                            @break
                            @case('Kepala Gudang')
                                {{ route('kepala-laporan-pengajuan') }}
                            @break

                            @default
                                {{ route('login') }}
                        @endswitch
                        " class=" btn btn-info btn-sm" target="__balnk">
                        <i class="fas fa-file-download mr-2"></i>Download Laporan
                    </a>
                </div>
                <h2 class="section-title" style="padding-top: 30px;">Data Pengajuan</h2>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="text-md-right mt-4">
                            ...
                            <a href="
                                @switch(auth()->user()->role)                                                                                                                                             
                                    @case('Admin Gudang')
                                        {{ route('print-laporan-pengajuan', $data->id) }}
                                    @break
                                    @case('SPV')
                                        {{ route('spv-print-laporan-pengajuan', $data->id) }}
                                    @break
                                    @case('Kepala Gudang')
                                        {{ route('kepala-print-laporan-pengajuan', $data->id) }}
                                    @break
